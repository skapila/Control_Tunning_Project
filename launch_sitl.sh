...
APP_PATH=  /home/bot-lab/ardupilot/Tools/autotest/sim_vehicle.py -v ArduCopter --map  --console -f JSON --add-param-file=/home/bot-lab/ardupilot_gazebo/config/gazebo-iris-gimbal.parm
